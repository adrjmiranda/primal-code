		...
		<div class="content-data">
			<div class="inner">
				<div class="data">
					<table>
						<?php if (count($data) > 0): ?>
							<?php require_once __DIR__ . '/partials/tables/author-thead.php'; ?>
							<?php require_once __DIR__ . '/partials/tables/author-body.php'; ?>
						<?php else: ?>
							<p class="no-data">No authors created yet!</p>
						<?php endif; ?>
					</table>
				</div>
			</div>
